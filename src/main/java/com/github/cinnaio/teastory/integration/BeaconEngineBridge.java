package com.github.cinnaio.teastory.integration;
...
/**
 * Optional bridge to BeaconEngine's service API. TeaStory remains
...
public final class BeaconEngineBridge {
    ...
    private void logLookupFailure(Throwable error) {
        ...
        this.plugin.getLogger().warning("[TeaStory] BeaconEngine integration is unavailable: " + error.getMessage());
    }
    ...
    private void logInvocationFailure(Throwable error) {
        ...
        this.plugin.getLogger().warning("[TeaStory] Failed to record a BeaconEngine item acquisition: " + error.getMessage());
    }
}
